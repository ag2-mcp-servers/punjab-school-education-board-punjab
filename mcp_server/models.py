...
class CertificateParameters(BaseModel):
    ...
    rollno: str = Field(..., description='Roll No', examples=['102012xxxx'])
...
class CemstCertificatePostRequest(BaseModel):
...
class CemstCertificatePostResponse(BaseModel):
...
class CemstCertificatePostResponse1(BaseModel):
...
class CemstCertificatePostResponse2(BaseModel):
...
class CemstCertificatePostResponse3(BaseModel):
...
class CemstCertificatePostResponse4(BaseModel):
...
class CemstCertificatePostResponse5(BaseModel):
...
class CemstCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class CfmstCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class CfmstCertificatePostResponse(BaseModel):
...
class CfmstCertificatePostResponse1(BaseModel):
...
class CfmstCertificatePostResponse2(BaseModel):
...
class CfmstCertificatePostResponse3(BaseModel):
...
class CfmstCertificatePostResponse4(BaseModel):
...
class CfmstCertificatePostResponse5(BaseModel):
...
class CfmstCertificatePostResponse6(BaseModel):
